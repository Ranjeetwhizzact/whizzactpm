        ...
        <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 mt-4">
                ...
                <button
                    ...
                    className="text-sm text-[#5CB660] hover:underline self-start sm:self-auto cursor-pointer"
                >
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 ">
                            ...
                            <button
                                ...
                                className="px-6 py-[2px] border border-blue-400 rounded-full cursor-pointer hover:bg-blue-5"
                            >
                                Time
                            </button>
                            <button
            ...
            <div className="overflow-x-auto rounded-[10px] border border-black my-4">
                <table className="min-w-full text-[12px] text-left border-collapse">
                    <thead>
                        <tr className="bg-[#D3FFD3] text-black">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-4">
                <div className="text-[#5CB660] text-[12px] font-medium self-start sm:self-center">Required: 63.35</div>
                <div className="flex gap-2 w-full sm:w-auto text-[20px] font-bold ">
                    ...
                    <button className="w-full sm:w-auto sm:flex-1 md:w-[200px] h-[40px] flex items-center justify-center px-4 py-2 bg-[#5CB660] text-white font-bold rounded-[10px]">
                        Buy
                    </button>
                </div>
            </div>
